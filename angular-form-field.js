...
angular.module('angular-form-field', [])
    ...
    .directive('formField', function($compile, $http, $templateCache, $interpolate, FormField) {
        ...
        return {
            ...
            compile: function(element, attrs) {
                ...
                return function postLink(scope, element, attrs) {
                    ...
                    loadTemplate(attrs.template || 'input').then(function(templateElement) {
